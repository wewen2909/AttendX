...
if (isset($_POST['tambah'])) {
    // Mendapatkan id_karyawan dari input form
    $karyawanId = $_POST['karyawan'];

    // Memeriksa keberadaan akun dengan id_karyawan yang sama
    $existingAkun = select("SELECT * FROM akun WHERE id_karyawan = $karyawanId");

    if ($existingAkun) {
        echo "<script>
            alert('Karyawan tersebut sudah memiliki akun!');
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        ...
                        <div class="mb-3">
                            <label for="karyawan">Id Karyawan</label>
                            <input type="text" name="karyawan" id="karyawan" class="form-control" required value="<?= $akun['id_karyawan']; ?>" readonly>
                        </div>

                        <div class="mb-3">
                            <label for="nama">Nama</label>
                            <input type="text" name="nama" id="nama" class="form-control" required value="<?= $akun['nama']; ?>"readonly>
                        </div>
                        <div class="mb-3">
                            <label for="username">Username</label>
                        ...
                        <div class="mb-3">
                            <label for="email">Email</label>
                            <input type="email" name="email" id="email" class="form-control" required value="<?= $akun['email']; ?>"readonly>
                        </div>
                        <div class="mb-3">
