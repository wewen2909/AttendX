...
if (isset($_POST['login'])) {
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        if (password_verify($password, $hasil['password'])) {
            ...
            if ($_SESSION['level'] != 1) {
                header("Location: rekap-absensi-karyawan.php");
                exit;
            }
...
<body class="text-center">
    ...
    <main class="form-signin">
        <form action="" method="POST">
            <img class="mb-4" src="assets/img/logo2.png" alt="">
            ...
            <p class="mt-5 mb-3 text-muted">&copy; Tugas Akhir
                <?= date('Y') ?>
            </p>
        </form>
    </main>
